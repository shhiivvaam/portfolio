...
import { TwitterIcon, GithubIcon, LinkedInIcon, LeetCodeIcon, InstagramIcon, SunIcon, MoonIcon } from './Icons';
...
const NavBar = () => {
    ...
    return (
        <header className='px-32 py-8 font-medium w-full flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8'>
            ...
            <div className='w-full flex justify-between items-center lg:hidden'>
                ...
                <nav className='flex items-center justify-center flex-wrap'>
                    <motion.a
                        href="https://github.com/shhiivvaam"
                        target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className="w-6 mr-3"
                    ...
                    <motion.a
                        href="https://twitter.com/shhiivvaam_"
                        target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className="w-6 mx-3"
                    ...
                    <motion.a
                        href="https://www.linkedin.com/in/shhiivvaam"
                        target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className="w-6 mx-3"
                    ...
                    <motion.a
                        href="https://leetcode.com/shhiivvaam/"
                        target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className="w-6 mx-3"
                    ...
                    <motion.a
                        href="https://www.instagram.com/shhiivvaam/"
                        target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className="w-6 ml-3"
